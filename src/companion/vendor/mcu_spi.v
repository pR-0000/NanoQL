...
reg [6:0] spi_sr_in = 7'd0;
reg spi_data_in_ready = 1'b0;

// read data on falling edge of spi clock
// spi_data_in_ready is a toggle crossing into clk. It must retain its
// phase while CS is inactive so the final byte cannot be erased before
// the receiving clock domain observes it.
